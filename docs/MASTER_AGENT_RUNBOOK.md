...
Default is `MASTER_AGENT_COMMAND_TEMPLATE='codex exec --dangerously-bypass-approvals-and-sandbox resume {session_id} -'`. Override only if you need a custom Codex invocation.
