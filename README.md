...
- Optional: `MASTER_AGENT_COMMAND_TEMPLATE` (default `codex exec --dangerously-bypass-approvals-and-sandbox resume --last -`; if you point this at `claude ...`, the dispatcher automatically adds `--dangerously-skip-permissions` unless it is already present)
