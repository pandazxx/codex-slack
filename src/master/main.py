...
def main() -> None:
    ...
    logging.getLogger(__name__).info(
        "master.startup registry_path=%s admin_channels=%s dry_run=%s base_image=%s auth_json_path=%s ssh_auth_sock_path=%s ssh_known_hosts_path=%s git_user=%s git_email=%s rate_limit=%d/%ds",
